# Goes in ~/.jupyter/jupyter_notebook_config.py
...
#  Default: ''
c.NotebookApp.browser = '/usr/bin/librewolf %s'
...
#  Choices: any of ['sha256', 'sha3_512', 'sha3_224', 'blake2b', 'blake2s', 'sha384', 'sha1', 'sha3_384', 'sha512', 'md5', 'sha3_256', 'sha224']
#  Default: 'sha256'
